...
function Hero() {
  return (
    <div className='mb-10 flex justify-center items-center h-screen'>
        <div className="container mx-auto overflow-hidden md:flex justify-between items-center ">
            <div className='md:flex-1 animate__animated animate__bounceInLeft text-center md:text-start'>
                <h1 className='md:text-7xl text-3xl font-bold md:leading-snug text-center md:text-start bg-gradient-to-r from-purple-600  to-pink-400 inline-block text-transparent bg-clip-text'>
                ...
                <p className='md:text-2xl py-5 text-center md:text-start'>Hi, I'm Faisal a freelancer graphics and web developer from Ghana, I help brands turn their ideas into huge quality products.</p>
